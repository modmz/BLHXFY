...
(function () {
  ...
  var getLocalConfig = function getLocalConfig() {
    ...
    var keys = ['autoDownload', 'bottomToolbar', 'displayName', 'removeScroller', 'hideSidebar', 'originText', 'transJa', 'transEn', 'keepBgm', 'font', 'transApi', 'fontBold', 'plainText', 'battleTrans', 'log'];
  ...
  */
  ...
  function _transLangMsg() {
    ...
    regeneratorRuntime.mark(function _callee(data, pathname) {
      var lang, msgs, phraseMap, _i, _Object$keys, key, text;
  ...
  function _showVoiceSub() {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee4(data, pathname, type) {
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
  ...
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(data, type, list) {
      ...
      }, _callee, null, [[1, 81], [5, 67, 71, 79], [14, 18, 22, 30], [23,, 25, 29], [36, 50, 54, 62], [55,, 57, 61], [72,, 74, 78]]);
    }));
