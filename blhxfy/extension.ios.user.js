...
(function () {
	...
	const getLocalConfig = () => {
	  ...
	  const keys = ['autoDownload', 'bottomToolbar', 'displayName', 'removeScroller', 'hideSidebar', 'originText', 'transJa', 'transEn', 'keepBgm', 'font', 'transApi', 'fontBold', 'plainText', 'battleTrans', 'log'];
	  keys.forEach(key => {
	...
	const getComicData = async () => {
	  if (!loaded$b) {
	    ...
	    list.forEach(arr => {
	      ...
	      const url = "https://gbf.danmu9.com/4ko/".concat(id, ".jpg");
